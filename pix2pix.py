...
# Loss functions
criterion_GAN = torch.nn.SmoothL1Loss()
...
def sample_images(batches_done):
    ...
    save_image(img_sample, 'log/images/%s/%s.png' % (opt.dataset_name, batches_done), nrow=5, normalize=True)


def save(image):
    save_image(image, 'ui' + str(random.choice(range(-10, 10))) + '.png', nrow=1, normalize=True)
