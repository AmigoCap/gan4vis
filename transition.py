...
def get_shake_from_canvas(user_canvas_path):
    img = Image.open(user_canvas_path)
    img = img.convert('L')
    img = np.array(img)
...
def interpol(dict_arg):
    ...
    shake = shake_ampl*get_shake_from_canvas(dict_arg['user_canvas_path'])
...
if __name__ == '__main__'  :
    ...
    dict_arg['output_path'] ='pred_test_lin.jpg'
    
    dict_arg['user_canvas_path'] ='zerohuit.jpg'
